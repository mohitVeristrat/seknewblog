...
<?php
	if (!$questionAsTitle || $questionAsTitle != "yes") { ?>
		...
		<h3><?php if ($tooltip) {echo '<a class ="hdQuTooltip">? <span><b></b>'.$tooltip.'</span></a>';} ?><?php //echo $questionText; ?> 				<?php if ($questionNumber >= 1) { echo ""; $questionNumber++; } else { echo ""; }?><?php the_title();?></h3>
