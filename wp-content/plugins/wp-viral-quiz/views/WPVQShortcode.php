<?php 
	...
	$wpvq_refresh_url 		= esc_url('//' . htmlspecialchars($_SERVER['HTTP_HOST']) . add_query_arg(array('wpvqas'=>'%%wpvqas%%'), remove_query_arg(array('playAgain'))));
...
<!--  Quiz Created thanks to WP Viral Quiz (v<?php echo WPVQ_VERSION; ?>) - https://www.institut-pandore.com/wp-viral-quiz/download -->
<a name="wpvq"></a>
			...
			<?php if ($wpvq_show_sharing): ?>
				<div id="wpvq-share-buttons">
					...
					<?php 
						...
						do_action('wpvq_add_social_buttons', $quiz->getId()); 
					?>
