											...
											<table class="form-table">
												<tbody>
													...
													<tr>
														...
														<td>
															<label for="wpvq-redirectionPage">
																<input type="text" id="wpvq-mailchimp-firstNameField" name="mailchimp_firstNameField" value="<?php echo isset($vqData['meta']['mailchimp']['firstNameField']) ? $vqData['meta']['mailchimp']['firstNameField']:''; ?>" placeholder="" style="width:270px;" />												
															</label>
														</td>
													</tr>
													<tr>
														...
														<td>
															<label for="wpvq-redirectionPage">
																<input type="text" id="wpvq-mailchimp-resultField" name="mailchimp_resultField" value="<?php echo isset($vqData['meta']['mailchimp']['resultField']) ? $vqData['meta']['mailchimp']['resultField']:''; ?>" placeholder="" style="width:270px;" />										
															</label>
														</td>
													</tr>
												</tbody>
