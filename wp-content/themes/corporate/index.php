...
<div id="posts" class="span-16 prepend-1 append-1">
	...
	<?php while (have_posts()) : the_post(); ?>
		...
		<div class="post" id="post-<?php the_ID(); ?>">
			...
			<div class="postcontent"><p><?php  echo strip_shortcodes(substr(get_the_content(), 0,900));(__('<br/>Continue reading...')); ?></p></div>
			<div class="posttags"><P><?php the_tags('Tags: ', ', ', ''); ?></P></div>
		</div>
