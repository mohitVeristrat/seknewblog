...
function viral_customize_preview_js() {
	wp_enqueue_script( 'viral_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20130508', true );
}
add_action( 'customize_preview_init', 'viral_customize_preview_js' );

function viral_customizer_script() {
	wp_enqueue_script( 'viral-customizer-script', get_template_directory_uri() .'/inc/js/customizer-scripts.js', array('jquery'),'', true  );
