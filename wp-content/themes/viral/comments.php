...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		<h3 class="comments-title">
			<?php
				printf( // WPCS: XSS OK.
					esc_html( _nx( 'One Comment', '%1$s Comments', get_comments_number(), 'comments title', 'viral' ) ),
		...
		<nav id="comment-nav-above" class="navigation comment-navigation" role="navigation">
			<div class="nav-links">
				...
				<div class="nav-previous"><?php previous_comments_link( esc_html__( 'Older Comments', 'viral' ) ); ?></div>
				<div class="nav-next"><?php next_comments_link( esc_html__( 'Newer Comments', 'viral' ) ); ?></div>
