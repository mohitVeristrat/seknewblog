...
function viral_setup() {
	 ...
	 * If you're building a theme based on Viral, use a find and replace
	 * to change 'viral' to the name of your theme in all the template files.
	 */
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'viral' ),
	) );
...
function viral_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'viral_content_width', 640 );
}
...
function viral_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer-block1', 'viral' ),
		'id'            => 'Footer-block1',
		'description'   => '',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer-block2', 'viral' ),
		'id'            => 'Footer-block2',
		'description'   => '',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer-block3', 'viral' ),
		'id'            => 'Footer-block3',
		'description'   => '',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
...
function viral_fonts_url() {
	 ...
	 */
	if ( 'off' !== _x( 'on', 'Open Sans font: on or off', 'viral' ) ) {
...
function viral_scripts() {
	...
	wp_enqueue_style( 'viral-fontawesome', get_template_directory_uri() . '/css/font-awesome.css', array(), '4.4.0' );
